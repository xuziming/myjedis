...
public class ShardedJedisTest extends Assert {
	...
	/**
	 * Test for "Issue - BinaryShardedJedis.disconnect() may occur memory leak". You
	 * can find more detailed information at
	 * https://github.com/xetorthio/jedis/issues/808
	 * 
