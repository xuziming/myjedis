...
public class JedisPoolTest extends Assert {
	...
	public void customClientName() {
		@SuppressWarnings("resource")
		JedisPool pool0 = new JedisPool(new JedisPoolConfig(), hnp.getHost(), hnp.getPort(), 2000, "foobared", 0,
	...
	public void returnNullObjectShouldNotFail() {
		@SuppressWarnings("resource")
		JedisPool pool = new JedisPool(new JedisPoolConfig(), hnp.getHost(), hnp.getPort(), 2000, "foobared", 0,
				"my_shiny_client_name");
